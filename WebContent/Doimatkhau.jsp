                    ...
                    <div class="m-t-10 p-20">
                        ...
                        <form class="m-t-20" action="Doimatkhau" method="post">
                        	<div class="form-group row">
                        		<div class="col-xs-12">
                                    <input class="form-control" type="hidden" name="username" required="" placeholder="" value="<%=users.getUserName()%>">
                                </div>
                        	</div>
                            <div class="form-group row">
                                <div class="col-xs-12">
                                    <input class="form-control" type="password" name="currentpass" required="" placeholder="Current password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                <div class="col-xs-12">
                                    <input class="form-control" type="password" name="confirmpass" required="" placeholder="Comfirm password">
                                </div>
                            </div>
