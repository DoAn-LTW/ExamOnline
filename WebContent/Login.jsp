			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<p>Bằng cách đăng nhập vào hệ thống, các bạn có thể dễ dàng
							xem các bài thi của mình cần phải thi, tham gia các kỳ thi do
							giáo viên chỉ định và xem điểm bài làm của mình.</p>
					</div>
					<div class="col-md-6">
